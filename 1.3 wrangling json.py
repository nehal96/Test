...
URL_MOST_VIEWED = URL_POPULAR + "mostviewed/all-sections/1.json"
API_KEY = {"popular": "ab951375937841039d5972eb4b4a69d8",
           "article": "ab951375937841039d5972eb4b4a69d8"}
...
def article_overview(kind, period):
    ...
    for i in range(0, len(data['results'])):
        ...
        titles.append(title)
        urls.append(url)
        media_metadata = results[i]['media'][0]['media-metadata']
        for i in range(0, len(media_metadata)):
            media_url = media_metadata[i]['url']
...
nytimes = get_popular(URL_POPULAR, "viewed", 30)
print nytimes
print (nytimes['results'][1]).keys()
print nytimes['results'][1]
print len(nytimes['results'])
print nytimes['results'][1]['url']
print nytimes['results'][1]['media'][0]['media-metadata'][0]['url']
print len(nytimes['results'][1]['media'][0]['media-metadata'])
